...
from scripts.generate_tree import TreeGenerator
...
class TestRecordTreeUpdate:
    ...
    def test_record_tree_update_new_file(self, tree_generator, temp_project):
        ...
        # Act
        with patch("scripts.generate_tree.datetime") as mock_datetime:
...
class TestMainFunction:
    ...
    def test_main_with_session(self, temp_project, capsys):
        ...
        with patch("sys.argv", ["generate_tree.py"] + test_args):
            with patch("scripts.generate_tree.TreeGenerator") as mock_generator_class:
                mock_instance = Mock()
                ...
                from scripts.generate_tree import main
