...
def get_validation_rules(work_item_type: str) -> Dict[str, Any]:
    ...
    rules = {
        'feature': {
            ...
            'optional_sections': ['User Story', 'Documentation Updates', 'Dependencies', 'Estimated Effort'],
        ...
        'deployment': {
            ...
            'special_requirements': {
                'deployment_procedure_subsections': ['Pre-Deployment Checklist', 'Deployment Steps', 'Post-Deployment Steps'],
                'rollback_procedure_subsections': ['Rollback Triggers', 'Rollback Steps'],
                'smoke_tests_min': 1,
                'acceptance_criteria_min_items': 3
            }
        }
    ...
    return rules.get(work_item_type, {
        'required_sections': [],
        'optional_sections': [],
        'special_requirements': {}
    })
...
def check_deployment_subsections(spec_content: str) -> List[str]:
    ...
    required_subsections = ['Pre-Deployment Checklist', 'Deployment Steps', 'Post-Deployment Steps']
